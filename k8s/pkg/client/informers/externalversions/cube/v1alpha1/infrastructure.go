...
import (
	...
	cube_v1alpha1 "github.com/rancher/rancher-cube-apiserver/k8s/pkg/apis/cube/v1alpha1"
	versioned "github.com/rancher/rancher-cube-apiserver/k8s/pkg/client/clientset/versioned"
	...
	v1alpha1 "github.com/rancher/rancher-cube-apiserver/k8s/pkg/client/listers/cube/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CubeV1alpha1().Infrastructures(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CubeV1alpha1().Infrastructures(namespace).Watch(options)
			},
		},
		&cube_v1alpha1.Infrastructure{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *infrastructureInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cube_v1alpha1.Infrastructure{}, f.defaultInformer)
}
