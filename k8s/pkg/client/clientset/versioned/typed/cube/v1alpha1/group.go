...
type GroupInterface interface {
	Create(*v1alpha1.Group) (*v1alpha1.Group, error)
	Update(*v1alpha1.Group) (*v1alpha1.Group, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Group, error)
	List(opts v1.ListOptions) (*v1alpha1.GroupList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Group, err error)
	GroupExpansion
}
...
func newGroups(c *CubeV1alpha1Client, namespace string) *groups {
	return &groups{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *groups) Get(name string, options v1.GetOptions) (result *v1alpha1.Group, err error) {
...
func (c *groups) List(opts v1.ListOptions) (result *v1alpha1.GroupList, err error) {
...
func (c *groups) Create(group *v1alpha1.Group) (result *v1alpha1.Group, err error) {
	result = &v1alpha1.Group{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) Update(group *v1alpha1.Group) (result *v1alpha1.Group, err error) {
	result = &v1alpha1.Group{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("groups").
...
func (c *groups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Group, err error) {
	result = &v1alpha1.Group{}
