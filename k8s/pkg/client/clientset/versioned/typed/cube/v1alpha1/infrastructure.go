...
import (
	...
	scheme "github.com/rancher/rancher-cube-apiserver/k8s/pkg/client/clientset/versioned/scheme"
...
func newInfrastructures(c *CubeV1alpha1Client, namespace string) *infrastructures {
