...
type TokenInterface interface {
	Create(*v1alpha1.Token) (*v1alpha1.Token, error)
	Update(*v1alpha1.Token) (*v1alpha1.Token, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Token, error)
	List(opts v1.ListOptions) (*v1alpha1.TokenList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Token, err error)
	TokenExpansion
}
...
func newTokens(c *CubeV1alpha1Client, namespace string) *tokens {
	return &tokens{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tokens) Get(name string, options v1.GetOptions) (result *v1alpha1.Token, err error) {
	result = &v1alpha1.Token{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tokens").
		Name(name).
...
func (c *tokens) List(opts v1.ListOptions) (result *v1alpha1.TokenList, err error) {
	result = &v1alpha1.TokenList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tokens").
...
func (c *tokens) Create(token *v1alpha1.Token) (result *v1alpha1.Token, err error) {
	result = &v1alpha1.Token{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tokens").
...
func (c *tokens) Update(token *v1alpha1.Token) (result *v1alpha1.Token, err error) {
	result = &v1alpha1.Token{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tokens").
...
func (c *tokens) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Token, err error) {
	result = &v1alpha1.Token{}
