...
var usersResource = schema.GroupVersionResource{Group: "cube.rancher.io", Version: "v1alpha1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "cube.rancher.io", Version: "v1alpha1", Kind: "User"}
