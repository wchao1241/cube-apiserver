...
import (
	v1alpha1 "github.com/rancher/rancher-cube-apiserver/k8s/pkg/apis/cube/v1alpha1"
...
var infrastructuresResource = schema.GroupVersionResource{Group: "cube.rancher.io", Version: "v1alpha1", Resource: "infrastructures"}

var infrastructuresKind = schema.GroupVersionKind{Group: "cube.rancher.io", Version: "v1alpha1", Kind: "Infrastructure"}
...
func (c *FakeInfrastructures) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Infrastructure, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(infrastructuresResource, c.ns, name, data, subresources...), &v1alpha1.Infrastructure{})
